    ...
    <section id="home" className="min-h-[90vh] grid grid-cols-1 xl:grid-cols-8">
      ...
      <div className="md:col-span-5 flex items-center justify-center p-8 xl:p-16">
        <div className="flex flex-col gap-8">
          ...
          Whether you’re a foodie, history buff, or nature lover, find tours tailored to your interests. Inspire others by creating and sharing your own tours with fellow explorers.
          </p>
